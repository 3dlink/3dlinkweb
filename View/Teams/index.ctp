<!-- <div class="teams index">
	...
	<tr>
		...
		<td><?php echo h($team['Team']['job']); ?>&nbsp;</td>
		<td><?php echo h($team['Team']['bio']); ?>&nbsp;</td>
		<td><?php echo h($team['Team']['photo']); ?>&nbsp;</td>
		<td class="actions">
            ...
            <div class="margenesHorizontales">
              ...
              <div class="col-md-6">
                <div class=" margenesVerticales" style="text-align: right;">
                  <buttom onclick="window.location.href=WEBROOT+'teams/add';" class="btn btn-primary">Add Member</buttom>
                </div>
              </div>
            ...
            <div class="margenesHorizontales">
              <table class="table table-striped">
                ...
                <?php foreach ($teams as $item): ?>
									<tr>
                    <td><?php echo h($item['Team']['name']); ?>&nbsp;</td>
					<td><?php echo h($item['Team']['job']); ?>&nbsp;</td>
	                  <td>
	                    <div style="display: block; width: 80px; margin: 0 auto;">
                        <?php if($this->UserAuth->getGroupId() == 1){ ?>
  	                      <a href="<?php echo $this->webroot;?>teams/edit/<?php echo $item['Team']['id'];?>" title="Editar Item" class="menuTable">
  	                        <span class="glyphicon glyphicon-pencil"></span>
  	                      </a>
  	                      <a href="<?php echo $this->webroot;?>teams/delete/<?php echo $item['Team']['id'];?>" onclick="if (confirm(&quot;¿Seguro que desea borrar el Equipo?&quot;)) { return true; } return false;" class="menuTable">
...
<p>
<?php echo $this->Paginator->counter(array('format' => __('Página {:page} de {:pages}, mostrando {:current} Team de {:count} en total.')));?>
</p>
<ul class="pagination">
<?php
