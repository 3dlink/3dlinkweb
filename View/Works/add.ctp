...
<div class="col-md-12">
        ...
        <div class="margenesVerticales" style="text-align:right;margin-top:30px;float:right;">
          <input type = "button" class="btn btn-primary" onclick="window.location.href = WEBROOT+'works';" title="regresar" value = "Back" style="width: 79px;">
...
$("#img1").dropzone({ url: WEBROOT+"start/upload/1", maxFilesize: 5, dictDefaultMessage: '<div class="col-xs-12 text-center" style="padding-bottom:20px"><img src="<?php echo $this->webroot; ?>img/file.png" alt="" /></div><p class="dropzone-add-message">Drag here the file to be uploaded or <a  class="add-files">select it from your computer</a></p>',maxFiles: 1, acceptedFiles: "image/jpeg,image/png,image/gif",
	success:function(data){
		$('#content_img1').append('<input type="hidden" value='+data.xhr.response+' name="data[Work][img1]">');
  }
});

$("#img2").dropzone({ url: WEBROOT+"start/upload/1", maxFilesize: 5, dictDefaultMessage: '<div class="col-xs-12 text-center" style="padding-bottom:20px"><img src="<?php echo $this->webroot; ?>img/file.png" alt="" /></div><p class="dropzone-add-message">Drag here the file to be uploaded or <a  class="add-files">select it from your computer</a></p>',maxFiles: 1, acceptedFiles: "image/jpeg,image/png,image/gif",
	success:function(data){
		$('#content_img2').append('<input type="hidden" value='+data.xhr.response+' name="data[Work][img2]">');
  }
});

$("#img3").dropzone({ url: WEBROOT+"start/upload/1", maxFilesize: 5, dictDefaultMessage: '<div class="col-xs-12 text-center" style="padding-bottom:20px"><img src="<?php echo $this->webroot; ?>img/file.png" alt="" /></div><p class="dropzone-add-message">Drag here the file to be uploaded or <a  class="add-files">select it from your computer</a></p>',maxFiles: 1, acceptedFiles: "image/jpeg,image/png,image/gif",
	success:function(data){
		$('#content_img3').append('<input type="hidden" value='+data.xhr.response+' name="data[Work][img3]">');
  }
});

$("#img4").dropzone({ url: WEBROOT+"start/upload/1", maxFilesize: 5, dictDefaultMessage: '<div class="col-xs-12 text-center" style="padding-bottom:20px"><img src="<?php echo $this->webroot; ?>img/file.png" alt="" /></div><p class="dropzone-add-message">Drag here the file to be uploaded or <a  class="add-files">select it from your computer</a></p>',maxFiles: 1, acceptedFiles: "image/jpeg,image/png,image/gif",
	success:function(data){
